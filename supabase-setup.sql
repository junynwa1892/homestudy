-- Supabase SQL Editor에서 한 번 실행하세요. 로그인 없는 공동 편집용 정책입니다.
...
insert into public.study_app_state (id, payload) values ('shared', '{"school":{},"study":{},"notes":{},"proofs":[],"schedules":[]}') on conflict (id) do nothing;
